...
peak RSS 0.29 GiB (well inside the 2 GiB cap; macOS refused `RLIMIT_AS`, so the
...
|--------:|--------------------:|---------------:|-----------------:|-----------------:|-------------:|
|     500 |                1.69 |           0.51 |             3.39 |           88,602 |        177.2 |
|   2,000 |                7.35 |           2.04 |            12.42 |          353,872 |        176.9 |
|   5,000 |               16.64 |           4.91 |            26.37 |          885,576 |        177.1 |
|  10,000 |               33.19 |           9.83 |            53.05 |        1,771,910 |        177.2 |
...
|---|---:|---:|---:|---:|---|
| observer off      | 0.0326 |   — |   0 |         0 | yes (reference) |
| bounded, every 25 | 0.0555 |  14 |  14 |   230,903 | yes |
| every epoch       | 0.6030 | 301 | 256 | 4,214,808 | yes |
...
It does **not** license a production cadence default. This solve costs 33 ms
total, so per-snapshot cost dominates it by construction and the 19x
