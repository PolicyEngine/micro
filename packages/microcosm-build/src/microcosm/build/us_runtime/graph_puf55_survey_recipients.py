"""Typed artifact-only PUF55 route preparation after current financial leaves.
...
class _Kernel(KernelBase):
    ...
    def run(self, context):
        ...
        # Finish the live run's source/store/support I/O, then seal detached
        # context/outputs and owners without another external read.
