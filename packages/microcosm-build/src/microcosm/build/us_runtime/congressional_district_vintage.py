...
#: under ``microcosm.build.us_runtime.data``. See the sibling ``.provenance.json``
...
def _state_total_proxy_source_district_fact(
    ...
    *,
    ...
    proxy["aggregate_fact_key"] = (
        f"microcosm.derived_fact.congressional_district_state_total_proxy.v1:{digest}"
    )
    proxy["semantic_fact_key"] = (
        f"microcosm.semantic_fact.congressional_district_state_total_proxy.v1:{digest}"
    )
...
def _translated_fact_shell(
    ...
    *,
    ...
    translated["aggregate_fact_key"] = (
        f"microcosm.derived_fact.congressional_district_vintage.v1:{digest}"
    )
    translated["semantic_fact_key"] = (
        f"microcosm.semantic_fact.congressional_district_vintage.v1:{digest}"
    )
