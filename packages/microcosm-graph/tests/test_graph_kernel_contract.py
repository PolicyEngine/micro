"""Kernel-protocol contracts of the frozen interface (amendments 13 and 20).
...
tolerances; and the two new declaration fields round-trip through JSON. A
``KEYED`` kernel declares that its draws come from stable coordinates rather
than from a position in the executor's generator.
"""
